...
# ondeck customization
declare -r ssl_opts="-Djavax.net.ssl.trustStore=project/.keystore -Djavax.net.ssl.trustStorePassword=changeit"
declare -r jit_opts="-XX:ReservedCodeCacheSize=256m -XX:+TieredCompilation"
declare -r default_jvm_opts_common="-Xms512m -Xmx1536m -Xss2m $ssl_opts $jit_opts $cms_opts"
